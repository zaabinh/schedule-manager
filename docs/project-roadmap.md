...
- 2026-08-22: Task Attachment extension **PASS** tại repository gate; migration V7, storage abstraction, upload/list/download/delete, IDOR protection, retry UI và full Docker E2E đã hoàn tất. Xem `phase-reports/task-attachment.md`.
