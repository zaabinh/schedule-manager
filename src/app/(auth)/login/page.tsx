...
export default function LoginPage() {
  ...
  return <main className="grid min-h-screen lg:grid-cols-[1.05fr_.95fr]">
    ...
    <section className="flex items-center justify-center bg-white p-6"><div className="w-full max-w-md">
      <div className="mb-8 flex items-center gap-3 lg:hidden"><Image src={SCHOOL_LOGO_PATH} alt={`Logo ${SCHOOL_NAME}`} width={64} height={64} priority className="h-16 w-16 rounded-xl border bg-white object-contain p-1"/><p className="max-w-[15rem] text-sm font-bold leading-snug text-[var(--primary-strong)]">{SCHOOL_NAME}</p></div>
